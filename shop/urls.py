...
urlpatterns = [
    ...
    path('', product_catalog_with_filter, name='product_filter_page'),
    path('product/create/', create_product, name='create_product'),
    path('product/details/<int:id>/', get_product_by_id, name='about_product'),
    path('product/review/<int:id>', UpdateRating.as_view(), name ='edit_review'),
    ...
    path('product/more/<int:id>/', get_one_product, name='get_one_product'),
]